...
func newRouter() *mux.Router {
	r := mux.NewRouter()
	r.HandleFunc("/people", getPersonHandler).Methods("GET")
	r.HandleFunc("/people", createPersonHandler).Methods("POST")
	r.HandleFunc("/characters", handler).Methods("GET")
	r.HandleFunc("/play", handler).Methods("GET")
